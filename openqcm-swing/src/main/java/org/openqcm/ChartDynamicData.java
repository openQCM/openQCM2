...
public class ChartDynamicData extends JPanel{
	private static final long serialVersionUID = -3163947102205784943L;
    ...
    private CombinedDomainXYPlot plotComb = new CombinedDomainXYPlot(new DateAxis("Time (hh:mm:ss)"));
    private ValueAxis domainAxis = plotComb.getDomainAxis();
